...
\hline
<!--(for user in topN)-->
\includegraphics[height=10mm]{@!user[-1]!@} @!user[-2]!@ (@!user[0]!@) & @!"%.2f" % float(user[1])!@ & @! "%.2f" % float(user[2])!@ & @! "%.2f" % float(user[3])!@ & @! "%.2f" % float(user[4])!@ & @! "%.2f" % float(user[5])!@ & @! "%.2f" % float(user[6])!@ & @! "%.2f" % float(user[7])!@ \\
\hline
<!--(end)-->
\end{longtable}
