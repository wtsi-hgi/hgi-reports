...
\hline
<!--(for row in topN)-->
\multirow{2}{*}{\includegraphics[height=10mm]{@!row['jpeg_filename']!@}} & @!row['fname']!@ (@!row['user_name']!@) & @! "%.2f" % float(row['done_core_weeks']) !@ & @! "%.2f" % float(row['done_cpu_time_avg']) !@ $\pm$ @! "%.2f" % float(row['done_cpu_time_stddev']) !@ & @! int(row['done_num_jobs']) !@ & @! "%.2f" % float(row['done_run_time_avg']) !@ \\
